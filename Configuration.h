...
#define CUSTOM_MACHINE_NAME "Monoprice Maker Select V2"
...
// LCD Corruption fix
// As per: https://marlinfw.org/docs/basics/troubleshooting.html
#define ST7920_DELAY_1 DELAY_NS(200) // After CLK LOW -- this one works
